...
Version  : 5.2.2
Release  : 81
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/Hmisc_5.2-2.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/Hmisc_5.2-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736801917
...
/usr/lib64/R/library/Hmisc/tests/ordGroupBoot.r
/usr/lib64/R/library/Hmisc/tests/pMedian.r
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/Hmisc/libs/Hmisc.so
/V4/usr/lib64/R/library/Hmisc/libs/Hmisc.so
