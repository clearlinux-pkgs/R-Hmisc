...
Version  : 5.0.0
Release  : 67
URL      : https://cran.r-project.org/src/contrib/Hmisc_5.0-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Hmisc_5.0-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678203630
